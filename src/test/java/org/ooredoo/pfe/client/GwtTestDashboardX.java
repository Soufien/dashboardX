 ...
 * for details.
 */
public class GwtTestDashboardX extends GWTTestCase {

  /**
   * Must refer to a valid module that sources this class.
   */
  public String getModuleName() {
    return "org.ooredoo.pfe.DashboardXJUnit";
  }
  ...
  public void testGreetingService() {
    ...
    target.setServiceEntryPoint(GWT.getModuleBaseURL() + "DashboardX/greet");
